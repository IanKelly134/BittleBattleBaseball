...
@Component({
  selector: 'app-search-milb-ateams',
  templateUrl: './search-milb-ateams.component.html',
  styleUrls: ['./search-milb-ateams.component.scss']
})
export class SearchMilbATeamsComponent implements OnInit {
