...
@Component({
  selector: 'app-search-milb-aaa-teams',
  templateUrl: './search-milb-aaa-teams.component.html',
  styleUrls: ['./search-milb-aaa-teams.component.scss']
})
export class SearchMilbAaaTeamsComponent implements OnInit {
